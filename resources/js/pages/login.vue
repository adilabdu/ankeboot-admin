    ...
    <div class="flex flex-col items-center h-full w-full col-span-6 py-12 gap-4">
      ...
      >
        <input
          ...
          name="username"
          id="username"
          class="autofill:bg-brand-secondary px-2 h-10 w-80 bg-white rounded-md border border-border-light shadow-sm"
        />
        <input
          ...
          class="autofill:bg-brand-secondary px-2 h-10 w-80 bg-white rounded-md border border-border-light shadow-sm"
        />
        <button class="capitalize bg-brand-primary rounded-md shadow-sm h-10 text-white">
          Log in
        </button>
      </form>
    </div>
