<template>
  ...
  >
    ...
    <template #rows="data">
      ...
      <LinkCell
        ...
        :to="'mailing-list/' + data['record']['id']"
      >
      ...
      <Cell
        name="phone"
        :hide="data.hide"
        class="w-[23%] text-center text-xs font-semibold text-subtitle"
      >
      ...
      <DateCell
        ...
        name="created_at"
        :hide="data.hide"
        :value="new Date(data['record']['created_at'])"
      />
    </template>
  </Table>
  ...
  >
    Are you sure you want to delete this subscriber from the mailing list? This action cannot be
    undone. The subscriber will no longer receive any mail from you.
  </ConfirmationModal>
</template>
