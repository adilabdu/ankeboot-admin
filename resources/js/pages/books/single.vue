    ...
    <div class="w-3/5 gap-8 flex flex-col">
        ...
        >
            ...
            <template #rows="data">
                ...
                <Cell name="quantity" :main="true" :hide="data.hide" class="w-[96%] text-xs font-semibold text-subtitle">{{ data['record']['quantity'] }} </Cell>
                <EnumCell class="w-[2%]" name="type" :hide="data.hide" :colors="['red', 'green']" :options="['sale', 'purchase']" :value="data['record']['type']" />
                <DateCell class="w-[2%]" name="date" :hide="data.hide" :value="data['record']['date']" />
