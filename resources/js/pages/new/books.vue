<template>
    ...
    <Teleport v-if="!! loading" to="#top-view">
        ...
        <Modal>
            ...
            <div class="w-full h-full flex items-end animate-slide-up">

                <div class="w-full h-[4rem] bg-white border border-border-light shadow-sm flex gap-4 items-center justify-center">
                    ...
                    <div class="flex items-center">
                        <p class="text-subtitle font-medium">Populating books record.</p>
                        <p class="text-subtitle font-medium">&nbsp;</p>
                        <p class="text-subtitle">This might take a few seconds</p>
                    </div>
