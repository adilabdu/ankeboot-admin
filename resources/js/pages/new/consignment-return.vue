        ...
        >
          <div class="w-full flex sm:flex-col gap-6">
            <DatePicker
              ...
              label="Return date"
              required
              v-model="newReturn.transaction_on"
            />
            <TextInput
              class="sm:w-full w-1/2"
              v-model="book['title']"
          ...
          <TextInput
            ...
            placeholder="Quantity of items to return"
            label="Quantity"
            required
          />
...
const total_return = computed(() =>
  newReturn.value.quantity.reduce((sum, a) => sum + parseInt(a?.amount), 0)
)
