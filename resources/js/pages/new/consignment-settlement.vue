    ...
    <Modal>
      ...
      >
        <Form
          modal
          @cancel="$emit('close')"
          :submit="submitNewSettlement"
          class="h-full w-full rounded-b-none"
          title="Make a new settlement"
        ...
        >
          <div class="w-full flex sm:flex-col gap-6">
            <DatePicker
              ...
              required
              v-model="newSettlement.transaction_on"
            />
            <TextInput
              class="sm:w-full w-1/2"
              v-model="book['title']"
          ...
          <TextInput
            v-model="newSettlement.quantity"
            placeholder="Quantity of items to settle"
            label="Quantity"
            required
          />
          <TextInput
            v-model="newSettlement.receipt"
            placeholder="Settlement receipt (PV****)"
            label="Receipt No"
            required
          />
        </Form>
