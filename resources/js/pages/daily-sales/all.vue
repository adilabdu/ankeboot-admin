<template>
    ...
    <div class="w-full h-fit flex flex-col-reverse gap-2 items-end">
        ...
        <div class="w-full grid grid-cols-4 gap-2 sm:grid-cols-1 sm:grid-rows-1">
            ...
            <InfoCard class="col-span-1 sm:row-span-1" label="Deposit / Report difference">
            ...
            <InfoCard class="col-span-1 sm:row-span-1" label="Sales Aggregate">
                <div class="flex justify-between items-center gap-2 w-full h-full">
                    <div v-if="! loading" class="items-center gap-1 flex">
                        <template v-if="range === 'Last week'">
            ...
            <InfoCard class="col-span-1 sm:row-span-1" label="Unsettled Credit Sales">
                <div class="flex justify-between items-center gap-2 w-full h-full">
                    <div v-if="! loading" class="items-center gap-1 flex">
                        <template v-if="range === 'Last week'">
