<template>
    ...
    <div class="w-full h-fit flex flex-col gap-2 items-end">
        <div class="w-full grid grid-cols-4 gap-2 sm:grid-cols-1 sm:grid-rows-1 relative">
            ...
            <div class="top-0 left-0 h-full py-1 -translate-x-[2.5rem] absolute flex flex-col justify-between">

                <button @click="decreaseRange" :disabled="range === 0" class="scale-95 focus:outline-none transition-shadow duration-150 disabled:hover:shadow-sm hover:shadow-md disabled:opacity-50 p-2 rounded-lg border border-border-dark bg-white shadow-sm">
                    <ChevronUpIcon class="scale-110 stroke-subtitle w-4 h-4" />
                </button>

                <button @click="increaseRange" :disabled="range === 2" class="scale-95 focus:outline-none transition-shadow duration-150 disabled:hover:shadow-sm hover:shadow-md disabled:opacity-50 p-2 rounded-lg border border-border-dark bg-white shadow-sm">
