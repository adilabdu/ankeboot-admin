  ...
  <Teleport to="#top-view">
    <Modal appear-from="top" @close="$emit('close')">
      <div
        id="formModal"
        ref="formModal"
        class="form-modal w-[45%] sm:w-full sm:rounded-b-lg sm:rounded-t-none sm:overflow-auto sm:max-h-[75%] sm:animate-slide-down-modal animate-scale-up"
      >
        <Form
          modal
          @cancel="$emit('close')"
            ...
            <div class="gap-6 flex flex-col">
              ...
              <template v-for="(sale, index) in data.sales" :key="index">
                <div class="relative flex sm:flex-col items-start justify-center w-full gap-2">
                  ...
                  <button
                    type="button"
                    @click="removeSales(index)"
                    v-if="index !== 0"
                    class="sm:absolute sm:top-0 sm:right-0 sm:mt-6 self-end rounded-md min-h-[2.5rem] min-w-[2.5rem] flex items-center justify-center"
                  >
                    <svg
                      width="15"
                      height="17"
            ...
            <div class="gap-6 flex flex-col">
              ...
              <template v-for="(deposit, index) in data.deposits" :key="index">
                <div class="flex flex-col w-full gap-2">
                  ...
                  <div
                    v-if="deposit.type === 'credit'"
                    class="flex items-start justify-start w-full gap-2"
                  >
                    <div
                      v-if="index !== 0"
              ...
              <div class="gap-6 flex flex-col">
                <template v-for="(expense, index) in data.expenses" :key="index">
                  ...
                  <div class="flex items-start justify-start w-full gap-2">
                    <div
                      class="self-end rounded-md h-10 min-w-[2.5rem] flex items-center justify-center sm:hidden"
                    />
                    <TextAreaInput
                      class="w-full"
                      required
