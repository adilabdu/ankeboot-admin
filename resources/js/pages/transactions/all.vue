<template>
  ...
  >
    <template #description>
      <p>Complete record of transactions made</p>
    </template>
    ...
    <template #rows="data">
      ...
      <LinkCell
        ...
        :main="true"
        :hide="data.hide"
        :value="data['record']['book_title']"
        :to="'transactions/' + data['record']['id']"
      >
      ...
      <EnumCell
        ...
        :value="data['record']['transaction_type']"
      />
      <Cell
        name="quantity"
        :hide="data.hide"
      ...
      <DateCell
        ...
        :hide="data.hide"
        :value="data['record']['transaction_date']"
      />
    </template>
  </Table>
</template>
