<template>
  <div class="relative">
    ...
    <div
      v-if="paginating"
      class="absolute top-0 bottom-0 flex w-full items-center justify-center gap-2"
    >
      <div class="flex gap-2 bg-white rounded-full px-4 py-2">
        ...
        <span class="text-subtitle font-medium"> Loading </span>
      </div>
    </div>
  </div>
</template>
