  ...
  <div ref="dropdown" class="sm:w-full w-fit flex gap-4 items-center justify-end">
    ...
    <div class="relative flex flex-col items-end gap-2 relative sm:w-full">
      <input
        ...
        type="text"
        class="icon-placeholder md:focus:outline-none focus:outline-brand-primary sm:focus:outline-none focus:outline-offset-2 px-3 border-[0.5px] border-border-light rounded-md sm:w-full w-64 bg-white h-10 shadow-sm flex items-center justify-between"
      />
