<template>
  ...
  <div class="flex flex-col items-end gap-1 relative sm:w-full h-fit">
    ...
    <div
      :class="[
        align === 'left' ? 'left-0' : '',
        dropDirection === 'up' ? '-translate-y-full top-0 mt-4' : 'translate-y-full -mb-2 bottom-0'
      ]"
      ref="datepicker"
      v-if="showPicker"
      class="z-50 absolute min-w-[304.2px] overflow-hidden bg-white rounded-md shadow-md border-[0.5px] border-border-dark flex flex-col"
    >
      <div
