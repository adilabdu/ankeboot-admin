      ...
      <div class="w-full h-full flex justify-center items-center">
        ...
        <div class="animate-scale-up flex flex-col w-[32rem] overflow-hidden rounded-xl bg-white">
          <div class="grow flex items-start h-full w-full p-6 gap-4">
            <div>
              <div class="bg-red-100 w-10 h-10 rounded-full flex items-center justify-center">
                ...
                >
                  <path
                    d="M11.0003 7.99999V11.75M1.69731 15.126C0.831309 16.626 1.91431 18.5 3.64531 18.5H18.3553C20.0853 18.5 21.1683 16.626 20.3033 15.126L12.9493 2.37799C12.0833 0.877991 9.91731 0.877991 9.05131 2.37799L1.69731 15.126V15.126ZM11.0003 14.75H11.0073V14.758H11.0003V14.75Z"
                    stroke="#EF4444"
                    stroke-width="1.5"
          ...
          <div class="p-6 flex items-center justify-end gap-2 h-16 w-full bg-wallpaper">
            <button
              @click="$emit('cancel')"
              class="focus:outline-none h-10 rounded-md font-medium bg-white text-black/75 border border-border-light px-5 focus:outline"
            >
              Cancel
            </button>
            <button
              ...
              @click="$emit('confirm')"
              class="flex items-center justify-center gap-2 focus:outline-none h-10 rounded-md bg-red-600 text-white px-6"
            >
              <svg
                v-if="loading"
