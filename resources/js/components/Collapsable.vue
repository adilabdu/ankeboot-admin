<template>
    ...
    <button :class="[!openCollapsable ? 'bg-brand-secondary' : '']" @click="toggleSection" @keydown.enter="toggleSection" type="button" class="text-subtitle w-fit rounded-full px-2 font-medium text-xs justify-start flex items-center gap-1">
        <svg class="transition-transform duration-300" :class="[!openCollapsable ? 'fill-brand-primary' : '-rotate-90 fill-subtitle']" width="10" height="7.5" viewBox="0 0 15 20" xmlns="http://www.w3.org/2000/svg">
