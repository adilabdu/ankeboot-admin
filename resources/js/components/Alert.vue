<template>
  <transition name="slide-fade">
    <div
      v-if="display"
      :class="[type]"
      class="animate-slide-in-from-left relative flex items-center justify-center w-fit min-w-[32rem] py-2 px-8 shadow-md border min-h-[3rem] rounded-md"
    >
      ...
      <svg
        ...
        height="10"
        viewBox="0 0 12 12"
        class="absolute right-4 top-0 bottom-0 my-auto"
