    ...
    <div class="sm:flex sm:flex-col grid grid-cols-12 w-full gap-6">
      ...
      <div class="sm:relative sticky top-8 h-fit w-full rounded-lg col-span-3">
        <ul class="p-2 font-medium items-end text-subtitle flex flex-col gap-1">
          <RouterLink
            v-slot="{ isActive }"
            active-class="ring-1 ring-brand-primary bg-brand-secondary text-brand-primary"
            to="/new/books"
            class="focus:outline-none flex items-center flex-row-reverse justify-between p-3 hover:bg-brand-secondary hover:text-brand-primary w-full text-right rounded-md group"
          >
            Register a new Book
            <svg
              width="19"
              ...
              class="opacity-0 fill-brand-primary"
          ...
          <li
            :class="[
              isUpdateTransaction
                ? 'ring-1 ring-brand-primary bg-brand-secondary text-brand-primary'
                : ''
            ]"
            class="focus:outline-none flex items-center flex-row-reverse justify-between p-3 w-full text-right rounded-md group"
          >
            ...
            <svg
              ...
              height="16"
              viewBox="0 0 19 16"
              :class="[isUpdateTransaction ? '!opacity-100' : '']"
              class="opacity-0 fill-brand-primary"
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
