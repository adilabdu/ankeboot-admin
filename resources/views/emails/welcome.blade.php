            ...
            <div role="banner">
                ...
                <div class="header" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);" id="emb-email-header-container">
                    ...
                    <div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #41637e;font-family: Avenir,sans-serif;Margin-left: 20px;Margin-right: 20px;" align="center">
                        <div class="logo-center" align="center" id="emb-email-header"><img style="display: block;height: auto;width: 100%;border: 0;max-width: 141px;" src="{{ $message->embed('assets/images/ankeboot-logo.jpg') }}" alt="" width="141" /></div>
                    </div>
                    <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
                </div>
            </div>
                            ...
                            <div class="column" style="text-align: left;color: #363f48;font-size: 16px;line-height: 24px;font-family: Karla,Calibri,Geneva,sans-serif;">
                                ...
                                <div style="Margin-left: 20px;Margin-right: 20px;">
                                    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                        <h1 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #363f48;font-size: 32px;line-height: 40px;font-family: Montserrat,DejaVu Sans,Verdana,sans-serif;text-align: center;"><strong>Welcome to the<br />
                                                Ankeboot family!</strong></h1><p style="Margin-top: 20px;Margin-bottom: 0;">Hi
                                        {{ $mailingList->name }}</p><p style="Margin-top: 20px;Margin-bottom: 20px;">We&#8217;re excited to have you on board. We&#8217;ve compiled a short list of the features that make our platform special so you can hit the ground running. We&#8217;re glad to have you, and excited to see what you create!</p>
                                    </div>
                                </div>

                                <div style="Margin-left: 20px;Margin-right: 20px;">
                                    <div class="btn btn--flat btn--large" style="Margin-bottom: 20px;text-align: left;">
                                        <![if !mso]><a style="border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;background-color: #363f48;font-family: Karla, Calibri, Geneva, sans-serif;" href="https://example.com">SEE ALL OF OUR FEATURES</a><![endif]>
                                        <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="https://example.com" style="width:182.25pt" arcsize="9%" fillcolor="#363F48" stroke="f"><v:textbox style="mso-fit-shape-to-text:t" inset="0pt,8.25pt,0pt,8.25pt"><center style="font-size:14px;line-height:24px;color:#FFFFFF;font-family:Karla,Calibri,Geneva,sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:1.5px">SEE ALL OF OUR<br>
                                  FEATURES</center></v:textbox></v:roundrect><![endif]--></div>
                                </div>
                    ...
                    <div class="layout stack" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                        <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
                            ...
                            <div class="column narrow" style="text-align: left;color: #363f48;font-size: 16px;line-height: 24px;font-family: Karla,Calibri,Geneva,sans-serif;Float: left;max-width: 320px;min-width: 200px; width: 320px;width: calc(72200px - 12000%);">
                                ...
                                <div style="Margin-left: 20px;Margin-right: 20px;">
                                    <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;" align="center">
                                        <img style="border: 0;display: block;height: auto;width: 100%;max-width: 472px;" alt="" width="160" src="{{ $message->embed('assets/images/img11-990000079e01453c.png')  }}" />
                                    </div>
                                </div>
                            ...
                            <div class="column wide" style="text-align: left;color: #363f48;font-size: 16px;line-height: 24px;font-family: Karla,Calibri,Geneva,sans-serif;Float: left;max-width: 400px;min-width: 320px; width: 320px;width: calc(8000% - 47600px);">
                                ...
                                <div style="Margin-left: 20px;Margin-right: 20px;">
                                    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                        <h2 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #363f48;font-size: 20px;line-height: 28px;font-family: Montserrat,DejaVu Sans,Verdana,sans-serif;"><span style="text-decoration: inherit;color: #ffffff;"><strong>Advanced analytics for every business</strong></span></h2><p style="Margin-top: 16px;Margin-bottom: 20px;"><span style="text-decoration: inherit;color: #ffffff;">&#8226; Keep track of your goals in real time<br />
                    ...
                    <div class="layout stack" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                        <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
                            ...
                            <div class="column narrow" style="text-align: left;color: #363f48;font-size: 16px;line-height: 24px;font-family: Karla,Calibri,Geneva,sans-serif;Float: left;max-width: 320px;min-width: 200px; width: 320px;width: calc(72200px - 12000%);">
                                ...
                                <div style="Margin-left: 20px;Margin-right: 20px;">
                                    <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;" align="center">
                                        <img style="border: 0;display: block;height: auto;width: 100%;max-width: 368px;" alt="" width="160" src="{{ $message->embed('assets/images/img21-990000079e01453c.png')  }}" />
                                    </div>
                                </div>
                            ...
                            <div class="column wide" style="text-align: left;color: #363f48;font-size: 16px;line-height: 24px;font-family: Karla,Calibri,Geneva,sans-serif;Float: left;max-width: 400px;min-width: 320px; width: 320px;width: calc(8000% - 47600px);">
                                ...
                                <div style="Margin-left: 20px;Margin-right: 20px;">
                                    <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                        <h2 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #363f48;font-size: 20px;line-height: 28px;font-family: Montserrat,DejaVu Sans,Verdana,sans-serif;"><strong>Calendars to keep everybody up to date</strong></h2><p style="Margin-top: 16px;Margin-bottom: 20px;">&#8226; Schedule campaigns and projects in advance<br />
                                            &#8226; Collaborate and share data among colleagues<br />
                                            &#8226; Establish clarity on deliverables and deadlines<br />
                                            &#8226; Keep track of project progression</p>
                                    </div>
                                </div>
                    ...
                    <div class="layout stack" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                        <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
                            ...
                            <div class="column narrow" style="text-align: left;color: #363f48;font-size: 16px;line-height: 24px;font-family: Karla,Calibri,Geneva,sans-serif;Float: left;max-width: 320px;min-width: 200px; width: 320px;width: calc(72200px - 12000%);">
                                ...
                                <div style="Margin-left: 20px;Margin-right: 20px;">
                                    <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;" align="center">
                                        <img style="border: 0;display: block;height: auto;width: 100%;max-width: 410px;" alt="" width="160" src="{{ $message->embed('assets/images/img3-990000079e01453c.png') }}" />
                                    </div>
                                </div>
                        ...
                        <div class="column" style="text-align: left;color: #363f48;font-size: 16px;line-height: 24px;font-family: Karla,Calibri,Geneva,sans-serif;">
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div class="btn btn--flat fullwidth btn--large" style="Margin-bottom: 20px;text-align: center;">
                                    ...
                                    <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="https://example.com" style="width:420pt" arcsize="9%" fillcolor="#363F48" stroke="f"><v:textbox style="mso-fit-shape-to-text:t" inset="0pt,8.25pt,0pt,8.25pt"><center style="font-size:14px;line-height:24px;color:#FFFFFF;font-family:Karla,Calibri,Geneva,sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:1.5px">GET MORE INFO ON OUR HELPFUL FEATURES</center></v:textbox></v:roundrect><![endif]--></div>
                            </div>
                                        ...
                                        <div style="margin-left: 0;margin-right: 0;Margin-top: 10px;Margin-bottom: 10px;">
                                            <div class="footer__share-button">
                                                ...
                                                <table style="border-collapse: collapse;table-layout: fixed;display: inline;" cellpadding="0" cellspacing="0"><tbody><tr><td class="flexible-footer__share-button__container" style="margin-bottom: 10px;mso-line-height-rule: exactly;display: inline-block;margin-left: 5px;margin-right: 5px;">
                                                            <fblike class="icon-white" style="border-radius: 2px;color: white;display: inline-block;font-size: 11px;font-weight: bold;line-height: 19px;text-align: left;text-decoration: none;border-style: solid;border-width: 4px 0 4px 4px;mso-border-width-alt: 4px 8px 8px 8px;background-color: #363f48;border-color: #363f48;mso-border-color-alt: #363f48;width: 81px;box-sizing: content-box;">
                                                            ...
                                                            <forwardtoafriend class="icon-white" style="border-radius: 2px;color: white;display: inline-block;font-size: 11px;font-weight: bold;line-height: 19px;text-align: left;text-decoration: none;border-style: solid;border-width: 4px 0 4px 4px;mso-border-width-alt: 4px 8px 8px 8px;background-color: #363f48;border-color: #363f48;mso-border-color-alt: #363f48;width: 81px;box-sizing: content-box;" lang="en">
                                    ...
                                    <table style="border-collapse: collapse;table-layout: fixed;width: 100%;" cellpadding="0" cellspacing="0"><tbody><tr><td><div class="column js-footer-additional-info" style="text-align: center;font-size: 12px;line-height: 19px;color: #363f48;font-family: Karla,Calibri,Geneva,sans-serif;display: inline;width: 100%;" align="center">
                                                    <div style="margin-left: 0;margin-right: 0;Margin-top: 10px;Margin-bottom: 10px;">
                                                        <div class="email-footer__additional-info" style="font-size: 12px;line-height: 19px;margin-bottom: 18px;margin-top: 0px;">
                                                            <div bind-to="address"><p class="email-flexible-footer__additionalinfo--center" style="Margin-top: 0;Margin-bottom: 0;">Ankeboot Bookstore + Publishing</p><p class="email-flexible-footer__additionalinfo--center" style="Margin-top: 0;Margin-bottom: 0;">Ankeboot General Trading PLC</p><p class="email-flexible-footer__additionalinfo--center" style="Margin-top: 0;Margin-bottom: 0;">Addis Ababa, Ethiopia</p><p class="email-flexible-footer__additionalinfo--center" style="Margin-top: 0;Margin-bottom: 0;">4 Kilo, Across Science Faculty main gate</p></div>
                                                        </div>

                                                        <div class="email-footer__additional-info" style="font-size: 12px;line-height: 19px;margin-bottom: 15px;Margin-top: 18px;">
                                                            <div bind-to="permission"><p class="email-flexible-footer__additionalinfo--center" style="Margin-top: 0;Margin-bottom: 0;">You are recieving this email because you subscribed to our mailing list.</p></div>
                                                        </div>
